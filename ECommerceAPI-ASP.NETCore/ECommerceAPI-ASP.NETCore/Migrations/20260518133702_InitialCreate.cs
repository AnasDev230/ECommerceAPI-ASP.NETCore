        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BillingAddressSnapshot = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DescriptionPlainText = table.Column<string>(type: "nvarchar(max)", maxLength: 8000, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Shippings_Addresses_ShippingAddressId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    VariantDetailsSnapshot = table.Column<string>(type: "nvarchar(150)", maxLength: 150, nullable: true),
                    Quantity = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Shippings_ShippingAddressId",
                table: "Shippings",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ShoppingCartItems_ShoppingCartId_StockId",
                table: "ShoppingCartItems",
                columns: new[] { "ShoppingCartId", "StockId" },
                unique: true);
